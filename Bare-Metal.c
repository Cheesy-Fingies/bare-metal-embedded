...
-Write the base address and then all the associated registers below, in
offset order
-write all registers from base adress plus the offset 
-write all changes to a register, underneath the register in LSB to MSB order
*/
